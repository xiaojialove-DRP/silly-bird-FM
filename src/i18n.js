...
export const I18N = {
  zh: {
    ...
    done: "完成", shareMyStation: "✉ 生成我的电台", publishUpdate: "✉ 把最新的内容发布出去",
    ...
    restoreFromLink: "↺ 这是我自己的电台 · 恢复到这台设备",
  ...
  en: {
    ...
    done: "Done", shareMyStation: "✉ Generate my station", publishUpdate: "✉ Publish my latest changes",
    ...
    restoreFromLink: "↺ This is my own station · restore it here",
