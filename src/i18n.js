...
export const I18N = {
  zh: {
    ...
    revoked: "已撤回 · 之前的链接已经失效，再点「把最新的声音分享出去」会是一条全新的",
    revokeFailedNetwork: "撤回失败：连不上云端服务器，挂个 VPN 再试一次。",
    revokeFailedButCleared: "这条链接已经收不回来了，但本地记录已清除 · 再点一次「把最新的声音分享出去」会是一条全新的",
  ...
  en: {
    ...
    revoked: "Revoked · the old link no longer works. Click Share your latest sound again for a brand new one.",
    revokeFailedNetwork: "Revoke failed: can't reach the cloud server, try a VPN and try again.",
    revokeFailedButCleared: "This link can no longer be reclaimed, but it's been cleared locally · click Share your latest sound again for a brand new one",
